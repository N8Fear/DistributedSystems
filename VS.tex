...
\subsection{leader election in a synchronnous ring}
...
\subsubsection{Algorithm of Hirschberg and Sinclair (HS-Alg)}
...
\subsubsection{Time slice algorithm}
\begin{compactitem}
...
\subsubsection{Variable speeds algorithm}
\begin{compactitem}
...
\subsection{Leader election in a wireless environment}
\begin{compactitem}
...
\subsection{The Bully Algorithm(flooding) (Garcia-Mdina, 1982)}
